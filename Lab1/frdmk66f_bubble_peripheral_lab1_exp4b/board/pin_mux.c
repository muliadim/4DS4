...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(PORTB,16U,kPORT_MuxAlt2); // SOUT/MISO
    PORT_SetPinMux(PORTB,17U,kPORT_MuxAlt2); // SIN/MOSI
    PORT_SetPinMux(PORTB,10U,kPORT_MuxAlt2); // PCS0

    PORT_SetPinMux(PORTA,25U,kPORT_MuxAsGpio); //RST
    PORT_SetPinMux(PORTB,8U,kPORT_MuxAsGpio); //EN
}
